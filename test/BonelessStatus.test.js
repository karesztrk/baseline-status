...
import { BaselineIcon, BonelessStatus } from "../src/index.js";

describe("Boneldss-status", () => {
  const realFetch = window.fetch;

  window.customElements.define("baseline-status", BonelessStatus);
  ...
  it("is defined", () => {
    ...
    assert.instanceOf(el, BonelessStatus);
  });
