 ...
 */
class HeadlessStatus extends ShadowElement {
  /**
   * @type {Feature}
   */
  feature;
        ...
        >
          ...
          <div class="baseline-status-title" aria-hidden="true">
            ...
            <div class="baseline-status-browsers">
              <span><slot name="chrome"></slot>${this.renderSupportIcon(baseline, chrome)}</span>
              <span><slot name="edge"></slot>${this.renderSupportIcon(baseline, edge)}</span>
              <span><slot name="firefox"></slot>${this.renderSupportIcon(baseline, firefox)}</span>
              <span><slot name="safari"></slot>${this.renderSupportIcon(baseline, safari)}</span>
            </div>
          </div>
        </div>
